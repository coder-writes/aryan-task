...
export const Footer = () => {
  return (
    <footer id="footer" className="py-20 px-6 border-t border-slate-200 dark:border-white/10 bg-background dark:bg-background-dark relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        <div>
          ...
          <ul className="space-y-4 text-slate-600 dark:text-slate-400 text-sm">
            ...
            <li><a href="#" className="hover:text-slate-900 dark:hover:text-white transition-colors">Computer Vision Stack</a></li>
            <li><a href="#" className="hover:text-slate-900 dark:hover:text-white transition-colors">Analytics Dashboard</a></li>
            <li><a href="#" className="hover:text-slate-900 dark:hover:text-white transition-colors">Partner Programs</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-slate-600 dark:text-slate-400 text-sm">
            <li><a href="#" className="hover:text-slate-900 dark:hover:text-white transition-colors">About Genyx</a></li>
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-slate-200 dark:border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-mono text-slate-500 dark:text-slate-500 uppercase tracking-widest">
